...
namespace Peak.RP1210C
{
    public class PEAKRP32Plus : IDisposable
    {
        ...
        //public PEAKRP32Plus() : this(Environment.Is64BitProcess ? "PCANRP64" : "PCANRP32")
        public PEAKRP32Plus() : this(Environment.Is64BitProcess ? "PCANRP64" : "VE121032")
        {
        }
        ...
        {
            if (this.LoadFunctionsVersionA())
            {
                this.m_Implementation = PEAKRP32Plus.ImplementationLoadLevel.A;
            }
            else
            {
                this.m_Implementation = PEAKRP32Plus.ImplementationLoadLevel.None;
            ...
            if (this.LoadFunctionsVersionB())
            {
                this.m_Implementation |= PEAKRP32Plus.ImplementationLoadLevel.B;
            }
            else
            {
                this.m_Implementation |= PEAKRP32Plus.ImplementationLoadLevel.None;
            ...
            if (this.LoadFunctionsVersionC())
            {
                this.m_Implementation |= PEAKRP32Plus.ImplementationLoadLevel.C;
            }
            else
            {
                this.m_Implementation |= PEAKRP32Plus.ImplementationLoadLevel.None;
        ...
        private bool LoadFunctionsVersionB()
        {
            try
            {
                ...
                return this.m_PtrGetLastErrMsg != null && this.m_PtrReadVerX != null;
            }
            catch
            {
                return false;
        ...
        private bool LoadFunctionsVersionA()
        {
            try
            {
                ...
                PEAKRP32Plus.ConnectDelegate clientConnectDelegate
                    = (PEAKRP32Plus.ConnectDelegate)this.GetFunction("RP1210_ClientConnect", typeof(PEAKRP32Plus.ConnectDelegate));
                ...
                return this.m_PtrConnect != null && this.m_PtrDisconnect != null && (this.m_PtrSendMsg != null && this.m_PtrReadMsg != null) && (this.m_PtrSendCmd != null && this.m_PtrReadVer != null && this.m_PtrGetErrMsg != null) && this.m_PtrGetHwSts != null;
            }
            catch
            {
                return false;
        ...
        public short ReadMessage(short nClientID, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] byte[] fpchAPIMessage, short nBlockOnRead)
        {
            ...
            {
                return this.m_PtrReadMsg(nClientID, fpchAPIMessage, fpchAPIMessage != null ? (short)fpchAPIMessage.Length : (short)0, nBlockOnRead);
            }
        }
        ...
        public short SendCommand(RP1210CCommand nCommandNumber, short nClientID, byte[] fpchClientCommand)
        {
            ...
            {
                return this.m_PtrSendCmd(nCommandNumber, nClientID, fpchClientCommand, fpchClientCommand != null ? (short)fpchClientCommand.Length : (short)0);
            }
        }
